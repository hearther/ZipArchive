...
- (BOOL)writeData:(NSData *)data filename:(nullable NSString *)filename withPassword:(nullable NSString *)password withDate:(nullable NSDate*)date progress:(nullable void(^)(long long doneSize))progress;
